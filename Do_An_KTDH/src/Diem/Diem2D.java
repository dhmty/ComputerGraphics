 ...
 * @author Welcome
 */
public class Diem2D implements Tranformation {
    ...
    public java.awt.Point Rotate(java.awt.Point root, double alpha) {
        ...
        java.awt.Point sP = new Diem2D(this.x, this.y).Shifting(-root.x, -root.y);
        ...
        java.awt.Point sP2 = new Diem2D(nX, nY).Shifting(root.x, root.y);
        return sP2;
    }
    ...
    public Diem2D Cabinet(int x, int y, int z) {
