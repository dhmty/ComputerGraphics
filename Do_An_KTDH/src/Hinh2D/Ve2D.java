...
public class Ve2D {
    ...
    //thêm vào để vẽ cột đèn
    public BufferedImage drawSlamp(Point A,Point A1,Point B,Point B1,Point C,Point C1,
            Point D,Point D1,Point E,Point E1,Point O1,Point O2,Point O3,int R1,int R23, Color color) {
        img= drawRect(D, D1, color);
        img= drawRect(E, E1, color);
        img= drawRect(B, B1, color);
        img= drawRect(C, C1, color);
        img= drawRect(A, A1, color);
        img= drawCircle(O1,R1,Color.WHITE,1);
        img= drawCircle(O2,R23,Color.WHITE,1);
        img= drawCircle(O3,R23,Color.WHITE,1);
